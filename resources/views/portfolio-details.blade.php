...
<!-- Mirrored from jthemes.net/themes/html/growim/portfolio-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Oct 2024 11:27:14 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Portfolio Details || Growim || HTML Template For Creative Digital Marketing Agency</title>
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/favicons/apple-touch-icon.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/favicons/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/favicons/favicon-16x16.png" />
    <link rel="manifest" href="assets/images/favicons/site.webmanifest" />
    <meta name="description" content="Growim is the perfect design HTML specially for digital marketing, creative web agencies, SEO marketing and web development agencies. We can also use this as a multipurpose, we have build it in a way so it suits almost all categories of businesses. GrowIm is built with HTML." />
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                                                        ...
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="col-md-6 col-lg-4">
                                                                    <div class="demo-one__card">
                                                                        <div class="demo-one__image">
                                                                            <img src="assets/images/growim-landing/home-1.jpg" alt="growim">
                                                                            <div class="demo-one__btns">
                                                                                <a href="index.html" class="growim-btn demo-one__btn">
                                                                                    <span class="growim-btn__text">Multi Page</span>
                                                                                </a><!-- /.thm-btn demo-one__btn -->
                                                                                <a href="index-one-page.html" class="growim-btn demo-one__btn">
                                                                                    <span class="growim-btn__text">One Page</span>
                                                                                </a><!-- /.thm-btn demo-one__btn -->
                                                                            </div><!-- /.demo-one__btns -->
                                                                        </div><!-- /.demo-one__image -->
                                                                ...
                                                                <div class="col-md-6 col-lg-4">
                                                                    <div class="demo-one__card">
                                                                        <div class="demo-one__image">
                                                                            <img src="assets/images/growim-landing/home-2.jpg" alt="growim">
                                                                            <div class="demo-one__btns">
                                                                                <a href="index-2.html" class="growim-btn demo-one__btn">
                                                                                    <span class="growim-btn__text">Multi Page</span>
                                                                                </a><!-- /.thm-btn demo-one__btn -->
                                                                                <a href="index-2-one-page.html" class="growim-btn demo-one__btn">
                                                                                    <span class="growim-btn__text">One Page</span>
                                                                                </a><!-- /.thm-btn demo-one__btn -->
                                                                            </div><!-- /.demo-one__btns -->
                                                                        </div><!-- /.demo-one__image -->
                                                                ...
                                                                <div class="col-md-6 col-lg-4">
                                                                    <div class="demo-one__card">
                                                                        <div class="demo-one__image">
                                                                            <img src="assets/images/growim-landing/home-3.jpg" alt="growim">
                                                                            <div class="demo-one__btns">
                                                                                <a href="index-3.html" class="growim-btn demo-one__btn">
                                                                                    <span class="growim-btn__text">Multi Page</span>
                                                                                </a><!-- /.thm-btn demo-one__btn -->
                                                                                <a href="index-3-one-page.html" class="growim-btn demo-one__btn">
                                                                                    <span class="growim-btn__text">One Page</span>
                                                                                </a><!-- /.thm-btn demo-one__btn -->
                                                                            </div><!-- /.demo-one__btns -->
                                                                        </div><!-- /.demo-one__image -->
                                                                ...
                                                                <div class="col-md-6 col-lg-4">
                                                                    <div class="demo-one__card">
                                                                        <div class="demo-one__image">
                                                                            <img src="assets/images/growim-landing/home-4.jpg" alt="growim">
                                                                            <div class="demo-one__btns">
                                                                                <a href="index-4.html" class="growim-btn demo-one__btn">
                                                                                    <span class="growim-btn__text">Multi Page</span>
                                                                                </a><!-- /.thm-btn demo-one__btn -->
                                                                                <a href="index-4-one-page.html" class="growim-btn demo-one__btn">
                                                                                    <span class="growim-btn__text">One Page</span>
                                                                                </a><!-- /.thm-btn demo-one__btn -->
                                                                            </div><!-- /.demo-one__btns -->
                                                                        </div><!-- /.demo-one__image -->
                                                                ...
                                                                <div class="col-md-6 col-lg-4">
                                                                    <div class="demo-one__card">
                                                                        <div class="demo-one__image">
                                                                            <img src="assets/images/growim-landing/home-5.jpg" alt="growim">
                                                                            <div class="demo-one__btns">
                                                                                <a href="index-5.html" class="growim-btn demo-one__btn">
                                                                                    <span class="growim-btn__text">Multi Page</span>
                                                                                </a><!-- /.thm-btn demo-one__btn -->
                                                                                <a href="index-5-one-page.html" class="growim-btn demo-one__btn">
                                                                                    <span class="growim-btn__text">One Page</span>
                                                                                </a><!-- /.thm-btn demo-one__btn -->
                                                                            </div><!-- /.demo-one__btns -->
                                                                        </div><!-- /.demo-one__image -->
        ...
        <section class="page-header page-header--details">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Generation Of Wealth</h2>
                <ul class="growim-breadcrumb list-unstyled">
                    <li><a href="index.html">Home</a></li>
                    <li><span>Portfolio Details</span></li>
                    <li><span>Generation Of Wealth</span></li>
        ...
        <section class="portfolio-details">
            <div class="container">
                <div class="portfolio-details__image">
                    <img src="assets/images/portfolio/portfolio-details-1.jpg" alt="growim">
                </div>
                <div class="row">
                    <div class="col-lg-8">
                        <div class="portfolio-details__content">
                            ...
                            <p class="portfolio-details__text">
                                At tempus aenean sapien torquent sed diam class efficitur mus morbi eros dictum quam augue ac laor
                                eet ligula libero mi commodo nibh hac fermentum orci ad pharetra consequat justo duis turpis lorem
                                elit dui consectetur magnis lacinia odio per placerat vestibulum volutpat mauris mollis primis
                                imperdiet posu ere ex enim gravida cras congue
                            </p>
                            <p class="portfolio-details__text">
                                pellentesque vulputate malesuada dictumst fames interdum cursus an te tellus porta ullamcorper accumsan
                                non eu adipiscing integer venenatis sagittis arcu curae finibus ridi culus aliquam velit lobortis senectus
                                vitae sollicitudin sit consectetuer ultricies rutrum parturient pede nisi nascetur habitant netus quisque
                                elementum inceptos nam felis penatibus feugiat
                            </p>
                            <h3 class="portfolio-details__title">Project Goals</h3>
                            <p class="portfolio-details__text">
                                At tempus aenean sapien torquent sed diam class efficitur mus morbi eros dictum quam augue ac laor eet ligula
                                libero mi commodo nibh hac fermentum orci ad pharetra consequat justo duis turpis lorem elit dui consectetur
                                magnis lacinia odio per placerat vestibulum volutpat mauris mollis primis imperdiet posu ere ex enim gravida
                                cras congue
                            </p>
                            <ul class="portfolio-details__list">
                                <li>
                            ...
                            <div class="row mb gutter-y-30">
                                <div class="col-md-6">
                                    <div class="portfolio-details__content__image">
                                        <img src="assets/images/portfolio/portfolio-details-2.jpg" alt="growim">
                                    </div>
                                </div><!-- /.col-md-6 -->
                                <div class="col-md-6">
                                    <div class="portfolio-details__content__image">
                                        <img src="assets/images/portfolio/portfolio-details-3.jpg" alt="growim">
                                    </div>
                                </div><!-- /.col-md-6 -->
                            </div>
                            <p class="portfolio-details__text">
                            ...
                            <div class="portfolio-details__pagination">
                                <a class="portfolio-details__pagination__item" href="portfolio-details.html">
                                    <img src="assets/images/portfolio/pagination-prev.jpg" alt="growim">
                                    Previous
                                </a>
                                <a class="portfolio-details__pagination__item" href="portfolio-details.html">
                                    Next
                                    <img src="assets/images/portfolio/pagination-next.jpg" alt="growim">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="portfolio-details__info">
                            <h3 class="portfolio-details__info__title">Project Information</h3>
                            <ul class="portfolio-details__info__list">
                                <li><span>Client:</span>jhon son smith</li>
                                <li><span>Category:</span>car servicing</li>
                                <li><span>Start Date:</span>10 June, 2023</li>
                                <li><span>End Date:</span>10 october, 2023</li>
                                <li><span>project budget:</span>$25800.99</li>
                            </ul>
                            <div class="portfolio-details__info__social">
                                <span class="portfolio-details__info__social__title">Follow on</span>
                                <a href="https://facebook.com/">
                                    <i class="fab fa-facebook-f" aria-hidden="true"></i>
                                    <span class="sr-only">Facebook</span>
                                </a>
                        ...
                        <div class="portfolio-details__contact text-center" style="background-image: url(assets/images/portfolio/portfolio-details-contact-bg.jpg);">
                            <div class="portfolio-details__contact__icon">
                                <i class="flaticon-phone"></i>
                            </div>
                            <p class="portfolio-details__contact__number">
        ...
        <footer class="main-footer main-footer--home-five">
            ...
            <div class="main-footer__shape" style="background-image: url(assets/images/shapes/footer-1-shape-1.png);"></div>
            <!-- /.main-footer__bg -->
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="footer-widget footer-widget--contact">
                                ...
                                <ul class="list-unstyled footer-widget__info">
                                    <li><i class="flaticon-pin"></i>Gregory Cartwright, 4059 Carling Avenue, Ugglebarnby YO22 3NJ</li>
    ...
    <aside class="sidebar-one">
        ...
        <div class="sidebar-one__content">
            ...
            <div class="sidebar-one__logo">
                <a href="index.html" aria-label="logo image"><img src="assets/images/logo-2-light.png" alt="growim" width="160"></a>
...
<!-- Mirrored from jthemes.net/themes/html/growim/portfolio-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Oct 2024 11:27:16 GMT -->
</html>