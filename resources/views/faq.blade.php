...
<!-- Mirrored from jthemes.net/themes/html/growim/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Oct 2024 11:27:18 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Our FAQ || Growim || HTML Template For Creative Digital Marketing Agency</title>
    <!-- favicons Icons -->
                ...
                <div class="row">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="100ms">
                        <div class="faq-page__image">
                            <img src="assets/images/resources/faq-page-1.jpg" alt="growim">
                        </div><!-- /.faq-page__image -->
                    </div><!-- /.col-lg-6 -->
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="200ms">
                        <div class="faq-page__content">
                            <div class="sec-title text-left">
                                ...
                                <h3 class="sec-title__title">Frequently Asked & Question</h3><!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                            <div class="faq-page__accordion growim-accrodion" data-grp-name="growim-accrodion">
                                <div class="accrodion">
