...
<head>
    ...
    <title>
        About Page || Growim || HTML Template For Creative Digital Marketing
        Agency
    </title>
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                    ...
                    <div class="main-header__inner">
                        ...
                        <div class="main-header__right">
                            ...
                            <a href="contact.html" class="growim-btn main-header__btn">
                                <span class="growim-btn__text">Work With Us</span> </a><!-- /.main-header__btn -->
                        </div>
                        <!-- /.main-header__right -->
                    </div>
                    <!-- /.main-header__inner -->
        ...
        <section class="work-process-two"
            style="
          background-image: url(assets/images/shapes/work-process-two-bg-shape.png);
        ">
            <div class="container">
                ...
                <div class="work-process-two__border wow fadeInUp" data-wow-delay="400ms"
                    style="
              background-image: url(assets/images/shapes/work-process-two-border.png);
            ">
                </div>
            </div>
        </section>
                ...
                <div class="row">
                            ...
                            <div class="row gutter-y-30">
                                <div class="col-md-6">
                                    <div class="why-choose-three__author">
                                        <img src="assets/images/resources/why-choose-three-author.jpg"
                                            alt="growim" />
                                ...
                                <div class="col-md-6">
                                    <div class="why-choose-three__call">
                                        ...
                                        <a class="why-choose-three__call__text"
                                            href="tel:+2085550112">+208-555-0112</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-7">
                        <div class="why-choose-three__image wow fadeInUp" data-wow-delay="100ms">
                            <div class="why-choose-three__image__bg wow fadeInRight" data-wow-delay="300ms"
                                style="
                    background-image: url(assets/images/shapes/why-choose-3-bg.png);
                  ">
                            </div>
        ...
        <section class="testimonials-four">
            <div class="testimonials-four__bg"
                style="
            background-image: url(assets/images/shapes/testimonials-bg-4.png);
          ">
            </div>

            <div class="testimonials-four__shape"
                style="
            background-image: url(assets/images/shapes/testimonials-4-shape-1.png);
          ">
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="testimonials-four__image">
                            <img src="assets/images/resources/testimonials-4-1.png" alt="growim" />
                        </div>
                    </div>

                    <div class="col-lg-6">
                        <div class="testimonials-four__wrapper">
                            <div class="sec-title text-left">
                                <h6 class="sec-title__tagline">Testimonials</h6>
                                <!-- /.sec-title__tagline -->

                                <h3 class="sec-title__title">People Say About Us</h3>
                                <!-- /.sec-title__title -->
                            </div>
                            <!-- /.sec-title -->

                            <div class="growim-stretch-element-inside-column">
                                <div class="testimonials-four__carousel growim-owl__carousel growim-owl__carousel--with-shadow owl-carousel"
                                    data-owl-options='{
								...
								"navText": ["<span class=\"flaticon-left-arrows\"></span>","<span class=\"flaticon-right-arrows\"></span>"],
								...
								"responsive": {
                                    ...
                                    <div class="item">
                                        <div class="testimonials-four__item">
                                            <div class="testimonials-four__item__quote">
                                                <img src="assets/images/shapes/quote-image-4.png" />
                                            </div>
                                            <!-- /.testimonials-four__item__quote -->

                                            <div class="testimonials-four__item__rating">
                                            ...
                                            <div class="testimonials-four__item__content">
                                                when an unknown printer took away galley of type aawer
                                                awtnd there are scrambled it to make a type many but
                                                also the leap into
                                            </div>
                                            <!-- /.testimonials-four__item__content -->

                                            <div class="testimonials-four__item__author">
                                                <img src="assets/images/resources/testi-4-1.jpg" alt="growim" />

                                                <h3 class="testimonials-four__item__name">
                                                    Kristin Watson
                                                </h3>

                                                <p class="testimonials-four__item__designation">
                                                    Web Designer
                                                </p>
                                            </div>
                                    ...
                                    <div class="item">
                                        <div class="testimonials-four__item">
                                            ...
                                            <div class="testimonials-four__item__author">
                                                <img src="assets/images/resources/testi-4-2.jpg" alt="growim" />
                                    ...
                                    <div class="item">
                                        <div class="testimonials-four__item">
                                            ...
                                            <div class="testimonials-four__item__author">
                                                <img src="assets/images/resources/testi-4-3.jpg" alt="growim" />
        ...
        <section class="team-four">
            <div class="container">
                <div class="team-four__top">
                    ...
                    <a class="growim-btn" href="team.html">
                        <span class="growim-btn__text">View ALL Member</span>
                    </a>
                </div>

                <div class="team-four__carousel growim-owl__carousel growim-owl__carousel--with-shadow growim-owl__carousel--basic-nav owl-carousel owl-theme"
                    data-owl-options='{
                    ...
                    <div class="item">
                        <div class="team-card-four wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="000ms">
                            ...
                            <div class="team-card-four__content">
                                ...
                                <p class="team-card-four__designation">Marketing</p>
                    ...
                    <div class="item">
                        <div class="team-card-four wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="1.5k">
                            ...
                            <div class="team-card-four__content">
                                ...
                                <p class="team-card-four__designation">CTO & Founder</p>
                                <!-- /.team-card-four__designation -->
                    ...
                    <div class="item">
                        <div class="team-card-four wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                            ...
                            <div class="team-card-four__content">
                                ...
                                <p class="team-card-four__designation">Developer</p>
                                <!-- /.team-card-four__designation -->
