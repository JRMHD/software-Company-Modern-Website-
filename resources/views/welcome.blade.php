...
<head>
    ...
    <title>
        Home One || Growim || HTML Template For Creative Digital Marketing Agency
    </title>
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="main-header__inner">
                    <div class="main-header__logo">
                        <a href="index.html">
                            <img src="assets/images/logo-dark.png" alt="Growim" width="160" />

                            <img src="assets/images/logo-light.png" alt="Growim" width="160" />
                        </a>
                    </div>
                    <!-- /.main-header__logo -->
                    ...
                    <div class="main-header__right">
                        ...
                        <a href="#" class="search-toggler main-header__search">
                            ...
                            <span class="sr-only">Search</span> </a><!-- /.search-toggler -->
                        ...
                        <a href="contact.html" class="growim-btn growim-btn--white main-header__btn">
        ...
        <section class="main-slider-one">
            <div class="main-slider-one__carousel growim-owl__carousel--with-counter owl-carousel"
                data-owl-options='{
                ...
                <div class="item">
                    <div class="main-slider-one__item">
                        <div class="main-slider-one__bg"
                            style="
                  background-image: url(assets/images/backgrounds/slider-1-1.png);
                ">
                        </div>

                        <div class="main-slider-one__shape-one"
                            style="
                  background-image: url(assets/images/shapes/slider-1-shape-1.png);
                ">
                        </div>
                        ...
                        <div class="main-slider-one__content">
                            <h5 class="main-slider-one__sub-title">go for advertising</h5>

                            <!-- slider-sub-title -->

                            <h2 class="main-slider-one__title">Think Digital</h2>
                            <!-- slider-title -->
                            ...
                            <div class="main-slider-one__btn">
                                <a class="growim-btn growim-btn--white" href="services.html">
        ...
        <div class="client-carousel">
            <div class="container">
                ...
                <div class="client-carousel__one growim-owl__carousel owl-theme owl-carousel"
                    data-owl-options='{
            ...
            "responsive":{
                ...
                "1200":{
                    ...
                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-1-1.png" alt="growim" />
                    </div>
                    <!-- /.owl-slide-item-->

                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-1-2.png" alt="growim" />
                    </div>
                    <!-- /.owl-slide-item-->

                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-1-3.png" alt="growim" />
                    </div>
                    <!-- /.owl-slide-item-->

                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-1-4.png" alt="growim" />
                    </div>
                    <!-- /.owl-slide-item-->

                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-1-5.png" alt="growim" />
                    </div>
                    <!-- /.owl-slide-item-->

                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-1-6.png" alt="growim" />
                    </div>
                    <!-- /.owl-slide-item-->

                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-1-7.png" alt="growim" />
                    </div>
                    <!-- /.owl-slide-item-->

                    <div class="client-carousel__one__item">
                        <img src="assets/images/resources/brand-1-8.png" alt="growim" />
                    </div>
                    <!-- /.owl-slide-item-->
                </div>
                <!-- /.thm-owl__slider -->
                ...
                <ul class="feature-one__list">
                    <li class="feature-one__item">
                        <div class="feature-one__item__img">
                            <img src="assets/images/shapes/feature-1-1.png" alt="growim" />
                        </div>
                    ...
                    <li class="feature-one__item">
                        <div class="feature-one__item__img">
                            <img src="assets/images/shapes/feature-1-2.png" alt="growim" />
                        </div>
        ...
        <section class="about-one">
            <div class="about-one__shape-one"
                style="
            background-image: url(assets/images/shapes/about-1-shape-1.png);
          "></div>

            <div class="about-one__shape-two"
                style="
            background-image: url(assets/images/shapes/about-1-shape-2.png);
          "></div>

            <div class="about-one__shape-three"
                style="
            background-image: url(assets/images/shapes/about-1-shape-3.png);
          "></div>

            <div class="about-one__shape-four"
                style="
            background-image: url(assets/images/shapes/about-1-shape-4.png);
          "></div>

            <div class="about-one__shape-five"
                style="
            background-image: url(assets/images/shapes/about-1-shape-5.png);
          "></div>

            <div class="about-one__shape-six"
                style="
            background-image: url(assets/images/shapes/about-1-shape-6.png);
          "></div>
                ...
                <div class="row">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="100ms">
                        <div class="about-one__content">
                            ...
                            <ul class="about-one__list">
                                <li>
                                    <div class="about-one__list__icon">
                                        <img src="assets/images/shapes/about-1-icon-1.png" alt="growim" />
                                    </div>
                                ...
                                <li>
                                    <div class="about-one__list__icon">
                                        <img src="assets/images/shapes/about-1-icon-2.png" alt="growim" />
                                    </div>
                            ...
                            <a class="growim-btn" href="about.html">
                    ...
                    <div class="col-lg-6">
                        <div class="about-one__image wow fadeInRight" data-wow-delay="200ms">
                            <div class="about-one__image__bg"
                                style="
                    background-image: url(assets/images/shapes/about-image-bg.png);
                  ">
                            </div>
                            ...
                            <div class="about-one__image__clients wow fadeInUp" data-wow-delay="400ms">
                                <img src="assets/images/resources/client-1-1.png" alt="growim" />

                                <img src="assets/images/resources/client-1-2.png" alt="growim" />

                                <img src="assets/images/resources/client-1-3.png" alt="growim" />

                                <img src="assets/images/resources/client-1-4.png" alt="growim" />
        ...
        <section class="service-one">
            <div class="service-one__shape-one"
                style="
            background-image: url(assets/images/shapes/service-1-shape-1.png);
          ">
            </div>

            <div class="service-one__shape-two"
                style="
            background-image: url(assets/images/shapes/service-1-shape-2.png);
          ">
            </div>

            <div class="service-one__shape-three"
                style="
            background-image: url(assets/images/shapes/service-1-shape-3.png);
          ">
            </div>

            <div class="service-one__shape-four"
                style="
            background-image: url(assets/images/shapes/service-1-shape-4.png);
          ">
            </div>

            <div class="service-one__shape-five"
                style="
            background-image: url(assets/images/shapes/service-1-shape-5.png);
          ">
            </div>
            ...
            <div class="container tabs-box">
                ...
                <div class="tabs-content">
                    <div class="tab fadeInUp animated" id="building">
                                ...
                                <div class="service-one__item text-center">
                                    <div class="service-one__item__wrapper">
                                        <div class="service-one__item__hover"
                                            style="
                          background-image: url(assets/images/resources/service-1-1-hover.png);
                        ">
                                        </div>

                                        <div class="service-one__item__icon"
                                            style="
                          background-image: url(assets/images/shapes/service-icon-bg.png);
                        ">
                                            <img src="assets/images/shapes/service-1-1.png" alt="growim" />
                                        </div>
                                        <!-- /.service-icon -->

                                        <h3 class="service-one__item__title">
                                            <a href="service-details.html">Keyword Research & Optimization</a>
                                        </h3>
                                        <!-- /.service-title -->
                                        ...
                                        <a class="service-one__item__rm" href="service-details.html">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="service-one__item text-center">
                                    <div class="service-one__item__wrapper">
                                        <div class="service-one__item__hover"
                                            style="
                          background-image: url(assets/images/resources/service-1-2-hover.html);
                        ">
                                        </div>
                          ...
                          background-image: url(assets/images/shapes/service-icon-bg.png);
                        ">
                                            <img src="assets/images/shapes/service-1-2.png" alt="growim" />
                                        </div>
                                        <!-- /.service-icon -->

                                        <h3 class="service-one__item__title">
                                            <a href="service-details.html">Video search optimization</a>
                                        </h3>
                                        <!-- /.service-title -->
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="service-one__item text-center">
                                    <div class="service-one__item__wrapper">
                                        <div class="service-one__item__hover"
                                            style="
                          background-image: url(assets/images/resources/service-1-3-hover.html);
                        ">
                                        </div>
                          ...
                          background-image: url(assets/images/shapes/service-icon-bg.png);
                        ">
                                            <img src="assets/images/shapes/service-1-3.png" alt="growim" />
                                        </div>
                                        <!-- /.service-icon -->

                                        <h3 class="service-one__item__title">
                                            <a href="service-details.html">E-commerce SEO optimization</a>
                                        </h3>
                                        <!-- /.service-title -->
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="service-one__item text-center">
                                    <div class="service-one__item__wrapper">
                                        <div class="service-one__item__hover"
                                            style="
                          background-image: url(assets/images/resources/service-1-4-hover.html);
                        ">
                                        </div>
                          ...
                          background-image: url(assets/images/shapes/service-icon-bg.png);
                        ">
                                            <img src="assets/images/shapes/service-1-4.png" alt="growim" />
                                        </div>
                                        <!-- /.service-icon -->
                    ...
                    <div class="tab fadeInUp animated active-tab" id="SEO">
                        <div class="row gutter-y-30">
                            <div class="col-xl-3 col-md-6">
                                <div class="service-one__item text-center">
                                    <div class="service-one__item__wrapper">
                    ...
                    <div class="tab fadeInUp animated" id="media">
                        <div class="row gutter-y-30">
                            <div class="col-xl-3 col-md-6">
                                <div class="service-one__item text-center">
                                    <div class="service-one__item__wrapper">
                    ...
                    <div class="tab fadeInUp animated" id="branding">
                        <div class="row gutter-y-30">
                            <div class="col-xl-3 col-md-6">
                                <div class="service-one__item text-center">
                                    <div class="service-one__item__wrapper">
                    ...
                    <div class="tab fadeInUp animated" id="creative">
                        <div class="row gutter-y-30">
                            <div class="col-xl-3 col-md-6">
                                <div class="service-one__item text-center">
                                    <div class="service-one__item__wrapper">
                    ...
                    <div class="tab fadeInUp animated" id="ecommerce">
                        <div class="row gutter-y-30">
                            <div class="col-xl-3 col-md-6">
                                <div class="service-one__item text-center">
                                    <div class="service-one__item__wrapper">
        ...
        <section class="why-choose-one">
            <div class="why-choose-one__shape-one"
                style="
            background-image: url(assets/images/shapes/why-choose-1-shape-1.png);
          ">
            </div>

            <div class="why-choose-one__shape-two"
                style="
            background-image: url(assets/images/shapes/why-choose-1-shape-2.png);
          ">
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="why-choose-one__image wow fadeInUp" data-wow-delay="100ms">
                            <div class="why-choose-one__image__bg"
                                style="
                    background-image: url(assets/images/shapes/why-choose-image-bg.png);
                  ">
                            </div>

                            <img src="assets/images/resources/why-choose-image-1.png" alt="growim" />
                        </div>
        ...
        <section class="portfolio-one">
            <div class="portfolio-one__shape-one"
                style="
            background-image: url(assets/images/shapes/portfolio-1-shape-1.png);
          ">
            </div>

            <div class="portfolio-one__shape-two"
                style="
            background-image: url(assets/images/shapes/portfolio-1-shape-2.png);
          ">
            </div>

            <div class="portfolio-one__shape-three"
                style="
            background-image: url(assets/images/shapes/portfolio-1-shape-3.png);
          ">
            </div>

            <div class="portfolio-one__shape-four"
                style="
            background-image: url(assets/images/shapes/portfolio-1-shape-4.png);
          ">
            </div>

            <div class="portfolio-one__shape-five"
                style="
            background-image: url(assets/images/shapes/portfolio-1-shape-5.png);
          ">
            </div>

            <div class="portfolio-one__shape-six"
                style="
            background-image: url(assets/images/shapes/portfolio-1-shape-6.png);
          ">
            </div>

            <h5 class="portfolio-one__title">Latest Work</h5>

            <div class="portfolio-one__slide-text wow fadeInUp" data-wow-delay="100ms">
            ...
            <div class="container">
                <div class="portfolio-one__item hover-item">
                    ...
                    <div class="portfolio-one__item__btn">
                        <a class="growim-btn growim-btn--white" href="portfolio-details.html">
                    ...
                    <div class="hover-item__box">
                        <img src="assets/images/portfolio/portfolio-1-1.jpg" alt="growim"
                ...
                <div class="portfolio-one__item hover-item">
                    ...
                    <div class="hover-item__box">
                        <img src="assets/images/portfolio/portfolio-1-2.jpg" alt="growim"
                            class="hover-item__box-img" />
                    </div>
                    <!-- /.hover-item__box -->
                </div>
                ...
                <div class="portfolio-one__item hover-item">
                    ...
                    <div class="hover-item__box">
                        <img src="assets/images/portfolio/portfolio-1-3.jpg" alt="growim"
                            class="hover-item__box-img" />
                    </div>
                    <!-- /.hover-item__box -->
                </div>
        ...
        <section class="package-one">
            <div class="package-one__shape-one"
                style="
            background-image: url(assets/images/shapes/package-1-shape-1.png);
          ">
            </div>

            <div class="package-one__shape-two"
                style="
            background-image: url(assets/images/shapes/package-1-shape-2.png);
          ">
            </div>

            <div class="package-one__shape-three"
                style="
            background-image: url(assets/images/shapes/package-1-shape-3.png);
          ">
            </div>

            <div class="package-one__shape-four"
                style="
            background-image: url(assets/images/shapes/package-1-shape-4.png);
          ">
            </div>
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="000ms">
                        <div class="package-one__item">
                            <div class="package-one__item__inner">
                                <div class="package-one__item__price">
                                    $49 <span>Par month</span>
                                </div>
                                <!-- /.package-card__price -->
                                ...
                                <p class="package-one__item__text">
                                    Integer sapien nec sapien sollicitudin ultrices Cras tempor
                                    id lorem et
                                </p>

                                <ul class="package-one__item__list">
                                    <li>
                                        <i class="flaticon-check"></i>Branding and design Identity
                                    </li>

                                    <li>
                                        <i class="flaticon-check"></i>Web site Marketing Solutions
                                    </li>

                                    <li><i class="flaticon-check"></i>Setup & Onboarding</li>

                                    <li>
                                        <i class="flaticon-check"></i>24/7 system Monitoring
                                    </li>

                                    <li><i class="flaticon-check"></i>Awesome Consulting</li>
                                </ul>

                                <a class="growim-btn" href="contact.html">
        ...
        <section class="team-one">
            <div class="team-one__shape-one" style="background-image: url(assets/images/shapes/team-1-shape-1.png)">
            </div>

            <div class="team-one__shape-two" style="background-image: url(assets/images/shapes/blog-1-shape-1.png)">
            </div>

            <div class="team-one__shape-three" style="background-image: url(assets/images/shapes/team-1-shape-3.png)">
            </div>

            <div class="team-one__shape-four" style="background-image: url(assets/images/shapes/team-1-shape-4.png)">
            </div>

            <div class="team-one__shape-five" style="background-image: url(assets/images/shapes/team-1-shape-5.png)">
            </div>

            <div class="team-one__shape-six" style="background-image: url(assets/images/shapes/team-1-shape-6.png)">
            </div>
				...
				"responsive": {
                    ...
                    <div class="item">
                        <div class="team-card wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="000ms">
                            <div class="team-card__image">
                                <img src="assets/images/team/team-1-1.jpg" alt="Wade Warren" />
                            </div>
                            <!-- /.team-card__image -->
                    ...
                    <div class="item">
                        <div class="team-card wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="100ms">
                            <div class="team-card__image">
                                <img src="assets/images/team/team-1-2.jpg" alt="Robert Fox" />
                            </div>
                            <!-- /.team-card__image -->
                    ...
                    <div class="item">
                        <div class="team-card wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                            <div class="team-card__image">
                                <img src="assets/images/team/team-1-3.jpg" alt="Jenny Wilson" />
                            </div>
                            <!-- /.team-card__image -->
                    ...
                    <div class="item">
                        <div class="team-card wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                            <div class="team-card__image">
                                <img src="assets/images/team/team-1-4.jpg" alt="Jacob Jones" />
                            </div>
                            <!-- /.team-card__image -->
        ...
        <section class="testimonials-one">
            <div class="testimonials-one__shape-one"
                style="
            background-image: url(assets/images/shapes/testimonials-1-shape-1.png);
          ">
            </div>

            <div class="testimonials-one__shape-two"
                style="
            background-image: url(assets/images/shapes/testimonials-1-shape-2.png);
          ">
            </div>

            <div class="testimonials-one__shape-three"
                style="
            background-image: url(assets/images/shapes/testimonials-1-shape-3.png);
          ">
            </div>

            <div class="testimonials-one__shape-four"
                style="
            background-image: url(assets/images/shapes/testimonials-1-shape-4.png);
          ">
            </div>
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="testimonials-one__image">
                            <div class="testimonials-one__image__bg"
                                style="
                    background-image: url(assets/images/shapes/testimonial-1-image-bg.png);
                  ">
                            </div>
                                ...
                                <div class="item">
                                    <div class="testimonials-one__item">
                                        ...
                                        <div class="testimonials-one__item__content">
                                            Sed ante elit, fringilla vitae laoreet sit amet, tempus
                                            et libero. Lorem ipsum dolor sit amet, consectetur
                                            adipiscing elit. Fusce eget quam quis turpis lacinia
                                            euismod cursus in arcu. Integer a purus dolor.
                                            Pellentesque finibus ut erat in sagittis. Sed semper
                                            dignissim
                                        </div>
                                        ...
                                        <div class="testimonials-one__item__author">
                                            ...
                                            <p class="testimonials-one__item__designation">
                                                Co, Founder
                                            </p>
                                        </div>
        ...
        <section class="blog-one">
            <div class="blog-one__shape-one" style="background-image: url(assets/images/shapes/blog-1-shape-1.png)">
            </div>

            <div class="blog-one__shape-two" style="background-image: url(assets/images/shapes/blog-1-shape-2.png)">
            </div>

            <div class="blog-one__shape-three"
                style="background-image: url(assets/images/shapes/blog-1-shape-3.png)"></div>

            <div class="blog-one__shape-four"
                style="background-image: url(assets/images/shapes/blog-1-shape-4.png)"></div>
            ...
            <div class="container">
                <div class="blog-one__top">
                    <div class="sec-title text-left">
                        ...
                        <h3 class="sec-title__title">Recent Blog Posts</h3>
                        <!-- /.sec-title__title -->
                    </div>
                    <!-- /.sec-title -->

                    <a class="growim-btn growim-btn--white" href="blog-list-right.html">
                ...
                <div class="blog-one__carousel growim-owl__carousel growim-owl__carousel--with-shadow growim-owl__carousel--basic-nav owl-carousel owl-theme"
                    data-owl-options='{
                        ...
                        <div class="blog-card wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                            ...
                            <div class="blog-card__content">
                                ...
                                <h3 class="blog-card__title">
                                    <a href="blog-details-right.html">Business strategy for marketing system</a>
                                </h3>
                                <!-- /.blog-card__title -->

                                <div class="blog-card__bottom">
                                    <div class="blog-card__author">
                                        <img src="assets/images/blog/blog-author-1-1.jpg" alt="growim" />
                                    ...
                                    <a href="blog-details-right.html" class="blog-card__link">
                                        <i class="fas fa-arrow-right"></i> </a><!-- /.blog-card__link -->
                                </div>
                            </div>
                            <!-- /.blog-card__content -->
                        </div>
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="100ms">
                            ...
                            <div class="blog-card__content">
                                ...
                                <h3 class="blog-card__title">
                                    <a href="blog-details-right.html">Why is Supply Chain Visibility So Important?</a>
                                </h3>
                                <!-- /.blog-card__title -->
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                            <div class="blog-card__image">
                                ...
                                <a href="blog-details-right.html" class="blog-card__image__link"><span
                                        class="sr-only">Discover a better way of redefining company goals</span>
                            ...
                            <div class="blog-card__content">
                                ...
                                <h3 class="blog-card__title">
                                    <a href="blog-details-right.html">Discover a better way of redefining company
                                        goals</a>
                                </h3>
                                <!-- /.blog-card__title -->
            ...
            <div class="container">
                <div class="mail-section__inner wow fadeInUp">
                    <div class="mail-section__shape-one"
                        style="
                background-image: url(assets/images/shapes/mail-shape-1.png);
              ">
                    </div>

                    <div class="mail-section__shape-two"
                        style="
                background-image: url(assets/images/shapes/mail-shape-2.png);
              ">
                    </div>

                    <div class="mail-section__shape-three"
                        style="
                background-image: url(assets/images/shapes/mail-shape-3.png);
              ">
                    </div>

                    <div class="mail-section__shape-four"
                        style="
                background-image: url(assets/images/shapes/mail-shape-4.png);
              ">
                    </div>
        ...
        <footer class="main-footer">
            ...
            <div class="main-footer__shape"
                style="
            background-image: url(assets/images/shapes/footer-1-shape-1.png);
          ">
            </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="footer-widget footer-widget--about">
                                ...
                                <p class="footer-widget__text">
                                    ...
                                    purus laoreet in ullamcorper vel malesuada sit amet enim.
                                </p>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="footer-widget footer-widget--contact">
                                ...
                                <ul class="list-unstyled footer-widget__info">
                                    <li>
                                        <i class="flaticon-pin"></i>Gregory Cartwright, 4059
                                        Carling Avenue, Ugglebarnby YO22 3NJ
                                    </li>

                                    <li>
                                        <i class="flaticon-phone"></i><a href="tel:+61086660112">+6108-666-0112</a>
                                    </li>
                ...
                <div class="container">
                    <div class="main-footer__bottom__inner">
                        <p class="main-footer__copyright">
                            &copy; Copyright <span class="dynamic-year"></span> by Growim
                            HTML Template.
                        </p>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img src="assets/images/logo-light.png"
                        width="155" alt="" /></a>
            </div>
    ...
    <aside class="sidebar-one">
        ...
        <div class="sidebar-one__content">
            <div class="sidebar-one__close"><i class="flaticon-close"></i></div>
            <!-- /.siderbar-close -->
